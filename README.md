...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" width="86" height="52" version="1.1" viewBox="0 0 86 52">
 <g transform="matrix(.9112 0 0 .9112 -44.01 -47.2)">
  <g transform="translate(-3)">
   <g transform="translate(-3)" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round">
    <g transform="matrix(.03176 0 0 .03176 53.63 51.8)" stroke-linecap="round" stroke-miterlimit="1.5" serif:id="ink!_just-squid">
    ...
    <g transform="matrix(.03391 0 0 .03391 80.42 64.28)" fill="#0e0e0e" stroke-miterlimit="1.414">
